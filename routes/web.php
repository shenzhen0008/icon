...
use App\Modules\Legal\Http\Controllers\PrivacyPolicyPageController;
use App\Modules\Legal\Http\Controllers\TermsOfServicePageController;
...
Route::get('/privacy', PrivacyPolicyPageController::class);
Route::get('/terms', TermsOfServicePageController::class);
