<nav id="mobile-nav" class="fixed inset-x-0 bottom-0 z-30 border-t border-theme bg-theme-secondary/90 backdrop-blur md:hidden">
  <div class="mx-auto grid max-w-4xl grid-cols-6">
    ...
    <a href="/stream-chat" class="text-scale-ui flex min-h-[4rem] flex-col items-center justify-center gap-[0.2rem] px-[clamp(0.25rem,1.8vw,0.55rem)] py-[clamp(0.55rem,2.5vw,0.85rem)] font-semibold {{ request()->is('stream-chat') ? 'text-[rgb(var(--theme-primary))]' : 'text-theme-secondary hover:text-[rgb(var(--theme-primary))]' }}">
