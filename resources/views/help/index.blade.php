...
<head>
  ...
  <title>{{ __('pages/help-center.meta_title', ['app_name' => config('app.name')]) }}</title>
  <x-meta.favicons />
...
<body class="bg-theme text-theme">
  ...
  <main data-page-cache-root data-page-cache-key="/help" data-page-cache-context="{{ auth('web')->id() === null ? 'guest' : 'user:'.auth('web')->id() }}" class="relative mx-auto w-full max-w-4xl px-4 pb-4 pt-[12rem] md:pb-8 md:pt-[30rem]">
