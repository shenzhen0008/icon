...
return [
    ...
    'bank_receiver' => [
        ...
        'account_name' => env('RECHARGE_BANK_ACCOUNT_NAME', env('APP_NAME', 'Zorai Radar').' TEST A'),
    ...
    'bank_receivers' => [
        'cmb_test_a' => [
            ...
            'account_name' => env('RECHARGE_BANK_A_ACCOUNT_NAME', env('APP_NAME', 'Zorai Radar').' TEST A'),
        ...
        'abc_test_b' => [
            ...
            'account_name' => env('RECHARGE_BANK_B_ACCOUNT_NAME', env('APP_NAME', 'Zorai Radar').' TEST B'),
        ...
        'icbc_test_c' => [
            ...
            'account_name' => env('RECHARGE_BANK_C_ACCOUNT_NAME', env('APP_NAME', 'Zorai Radar').' TEST C'),
